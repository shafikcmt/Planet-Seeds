...
.show-on-hover:hover  
  ul.dropdown-menu {
    display: block;    
                        ...
                        <div class="categories_wrap show-on-hover">
                            <button type="button" data-target="#navCatContent" aria-expanded="false" class="categories_btn dropdown-toggle" data-toggle="dropdown">
